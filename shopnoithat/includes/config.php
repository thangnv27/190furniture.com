...
$options = array(
    'general' => array(
        ...
        array("name" => "Nội dung ở cuối trang",
            "desc" => "",
            "id" => SHORT_NAME . "_footer_content",
            "std" => "",
            "type" => "textarea",
            "editor" => array(
                "wyswig" => true,
    ...
    'theme-options' => array(
        ...
        array("name" => "Thanh toán thành công",
            ...
            "type" => "select",
            "options" => $page_list),
        array("name" => "Kết quả báo giá sản phẩm",
            "desc" => "Trang hiển thị kết quả báo giá sản phẩm.",
            "id" => SHORT_NAME . "_pagePriceResult",
            "std" => '',
            "type" => "select",
            "options" => $page_list),
        array("type" => "close"),
        ...
        array("name" => "Phân trang sản phẩm",
            ...
            "std" => '12',
            "type" => "text"),
        array("name" => "Giảm giá toàn bộ (%)",
            "desc" => "Giảm giá cho toàn bộ sản phẩm. Ví dụ: 20",
            "id" => "global_discount",
            "std" => '0',
            "type" => "text"),
...
//            "type" => "textarea"),
    ...
    'payment-method' => array(
        ...
        array("name" => "Phương thức thanh toán",
            ...
            "desc" => ""),
        array("type" => "open"),
        array("name" => "Thanh toán khi nhận hàng",
            "desc" => "",
